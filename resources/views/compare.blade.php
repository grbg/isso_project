...
@section('content')
@vite(['resources/css/pages/compare.css'])
@vite(['resources/js/account/remove_compare.js'])
    <div class="container">
        <h1 class="h1">Сравнение квартир</h1>

        @if($apartments->isEmpty())
            <p>Вы ещё не добавили квартиры в сравнение.</p>
        @else
            <hr>
            ...
            @foreach($apartments as $apartment)
                <div class="apartment_item">
                    ...
                    <div class="apartment_data">
                        ...
                        <button type="button" class="remove_favorite_btn form__button secondary" data-id="{{ $apartment->id }}">
                            Удалить
                        </button>
                    </div>
                </div>
